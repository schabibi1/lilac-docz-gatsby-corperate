...
import varelaRound from '@fonts/VarelaRound-Regular.woff2'
import sawarabiGothic from '@fonts/SawarabiGothic-Regular.woff2'
...
export const BaseStyle = createGlobalStyle`
  ...
  @font-face {
    font-family: 'sawarabiGpthic';
    font-weight: 300;
    font-style: normal;
    src: url(${sawarabiGothic}) format('woff2');
  }
  ...
  *, *:before, *:after {
  ...
  body {
    margin: 0;
    padding: 0;
    font-family: 'Sawarabi Gothic', 'Varela Round', 'FaktSoft', Helvetica, sans-serif;
    font-size: 18px;
    font-weight: 300;
    line-height: 1.62;
